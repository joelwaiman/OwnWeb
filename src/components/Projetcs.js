...
const Projects = () => {
  const project = [
    ...
    { id: 2, name: 'Clon Twitter', link:'twitter-clone-lime.vercel.app', description: 'Proyecto hecho en React, con el objeto de crear una UI lo mas asemejada posible a la original. Control de estados, localStorage'}
  ]
