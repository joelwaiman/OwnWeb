...
const Home = () => {
    ...
    return (
        <section className="animate-fade animate-delay-700 flex flex-col justify-center items-center min-h-screen m-auto lg:w-[80%] max-w-[95%] text-text gap-10"
            ...
            <div className="px-4 md:px-6 z-50 max-w-full lg:max-w-[85%]">
                <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-12">
                    ...
                    <article className="animate-fade-left animate-delay-700 flex flex-col text-text items-center lg:items-start lg:text-start rounded-2xl shadow-[0_0_30px_0_rgba(0,0,0,0.3)] backdrop-blur-sm p-5 text-center w-full lg:w-3/4">
                        ...
                        <div
                            className="flex flex-wrap justify-center lg:justify-start w-full gap-4 text-3xl text-secondary py-5 animate-fade">
                            {iconsStack.map((icns) => {
                                return <div className="flex flex-col items-center min-w-fit hover:scale-110 transition-all duration-200"
                                    key={icns.id}>
                                    <span
                                        title={icns.title}>
                                        {icns.name}
